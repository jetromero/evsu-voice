    ...
    public function prepareDataFromSuggestions($suggestions)
    {
        ...
        foreach ($suggestions as $suggestion) {
            $row = [
                ...
                $suggestion['is_anonymous'] ? '' : $this->sanitizeValue($suggestion['author_email']),
                $this->sanitizeValue($suggestion['upvotes_count']),
                $this->sanitizeValue($suggestion['admin_response']),
                $this->sanitizeValue($suggestion['admin_name']),
                $this->sanitizeValue(date('Y-m-d H:i:s', strtotime($suggestion['created_at']))),
                $this->sanitizeValue(date('Y-m-d H:i:s', strtotime($suggestion['updated_at'])))
            ];
